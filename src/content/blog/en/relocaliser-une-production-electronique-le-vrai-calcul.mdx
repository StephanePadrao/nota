---
title: "Reshoring electronics production: the real math"
date: '2026-06-12'
description: >-
...
> **From experience.** On a production takeover I led, the first goal wasn't price but regaining control: writing the SOPs (assembly, configuration, validation) and building the test benches to fix defects in series rather than absorb them. The cost gap was real, on the order of five times cheaper in China and three times cheaper in Europe than in France, but it means nothing until production is mastered and documented. A cheap line that ships non-reproducible boards ends up costing more than an expensive line under control.
