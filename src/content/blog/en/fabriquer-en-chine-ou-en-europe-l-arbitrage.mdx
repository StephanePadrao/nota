...
> **From experience.** I've seen a design picked up after a simple request for quote: as soon as a product looks interesting, the file you sent can resurface elsewhere. Since then, I never hand over everything at once and I keep the differentiating blocks out of the quotation package. On cost, the gap is real, often several times cheaper, and the responsiveness is excellent. But it comes with a catch: without an unambiguous specification and without purchasing control (checking the components actually fitted, auditing the line), substitutions creep in, an out-of-tolerance resistor or an unvalidated equivalent IC. The right Asian supplier is very capable; you just have to leave nothing implicit.
