...
> **En pratique.** Aujourd'hui, aller de l'idée au POC va très vite : une carte Arduino ou Adafruit, un peu de code, une pièce imprimée en 3D, la démo tourne. C'est précisément ce qui piège. Rien de tout ça ne dit comment durcir le firmware pour la certification, sourcer le bon composant au bon prix, choisir le partenaire d'un moule d'injection ou d'une pièce alu sur mesure, écrire les protocoles de fabrication et viser les bons marquages (CE, FCC, EAC, etc.) selon les zones de vente. En studio de développement produit, ce passage est le quotidien, et c'est là que meurent les plannings, pas sur la démo. Le POC prouve l'idée ; il ne prouve rien de l'industrialisation.
