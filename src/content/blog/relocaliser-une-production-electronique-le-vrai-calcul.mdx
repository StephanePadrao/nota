...
> **Retour d'expérience.** Sur une reprise de production que j'ai pilotée, l'objectif premier n'était pas le prix mais de reprendre le contrôle : rédiger les SOP (montage, configuration, validation) et monter les bancs d'essai pour corriger les défauts en série au lieu de les subir. Le comparatif coût existait, de l'ordre de cinq fois moins cher en Chine et trois fois moins en Europe qu'en France, mais il ne veut rien dire tant que la production n'est ni maîtrisée ni documentée. Une ligne bon marché qui sort des cartes non reproductibles coûte plus cher, au final, qu'une ligne chère et sous contrôle.
