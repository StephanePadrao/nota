...
> **Da minha experiência.** Já vi um design retomado após um simples envio para orçamento: assim que um produto parece interessante, o ficheiro enviado pode reaparecer noutro lado. Desde então, nunca entrego tudo de uma vez e mantenho os blocos diferenciadores fora do dossiê de consulta. Quanto ao custo, a diferença é real, muitas vezes várias vezes mais barato, e a capacidade de resposta é excelente. Mas tem uma contrapartida: sem uma especificação sem ambiguidade e sem controlo das compras (verificar os componentes realmente montados, auditar a linha), aparecem substituições, uma resistência fora de tolerância ou um CI equivalente não validado. O bom fornecedor asiático é muito competente; só é preciso não deixar nada implícito.
