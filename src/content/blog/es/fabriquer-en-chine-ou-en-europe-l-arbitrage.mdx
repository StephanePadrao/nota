...
> **De mi experiencia.** He visto un diseño retomado tras un simple envío para cotización: en cuanto un producto parece interesante, el archivo enviado puede reaparecer en otra parte. Desde entonces, nunca entrego todo de golpe y mantengo los bloques diferenciadores fuera del expediente de consulta. En cuanto al costo, la diferencia es real, a menudo varias veces más barato, y la capacidad de respuesta es excelente. Pero tiene una contrapartida: sin una especificación sin ambigüedad y sin control de las compras (verificar los componentes realmente montados, auditar la línea), aparecen sustituciones, una resistencia fuera de tolerancia o un CI equivalente no validado. El buen proveedor asiático es muy competente; solo hay que no dejar nada implícito.
