...
> **En la práctica.** Hoy, ir de la idea al POC es muy rápido: una placa Arduino o Adafruit, algo de código, una pieza impresa en 3D, y la demo funciona. Eso es precisamente la trampa. Nada de eso dice cómo endurecer el firmware para la certificación, abastecer el componente correcto al precio correcto, elegir el socio para un molde de inyección o una pieza de aluminio a medida, escribir los protocolos de fabricación y apuntar a los marcados correctos (CE, FCC, EAC, etc.) según las zonas de venta. En un estudio de desarrollo de producto, ese paso es el pan de cada día, y es ahí donde mueren las planificaciones, no en la demo. El POC prueba la idea; no prueba nada de la industrialización.
