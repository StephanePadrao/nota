---
title: "Relocalizar una producción electrónica: el verdadero cálculo"
date: '2026-06-12'
description: >-
...
> **De mi experiencia.** En una recuperación de producción que dirigí, el primer objetivo no era el precio sino retomar el control: redactar los SOP (montaje, configuración, validación) y montar los bancos de prueba para corregir los defectos en serie en lugar de sufrirlos. La comparación de costos existía, del orden de cinco veces más barato en China y tres veces más barato en Europa que en Francia, pero no significa nada mientras la producción no esté dominada ni documentada. Una línea barata que produce placas no reproducibles acaba costando más que una línea cara bajo control.
