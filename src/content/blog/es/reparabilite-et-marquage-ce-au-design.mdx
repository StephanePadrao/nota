---
title: "Reparabilidad y marcado CE: se juega en el diseño, no al final del proyecto"
date: '2026-06-12'
description: >-
...
> **En la práctica.** Reducir el número de componentes no es solo cuestión de costo: menos piezas significan menos puntos de fallo y un producto más simple de reparar y reciclar. Un módulo integrado como el ESP32 reemplaza de golpe varios bloques que de otro modo se colocarían por separado alrededor de un MCU como un STM32: el transceptor o el módulo Wi-Fi dedicado, y la memoria EEPROM externa. Menos referencias en la lista de materiales, menos pistas que rutear, una placa más simple. La decisión se toma en la arquitectura, reparabilidad y costo en la misma mano.
