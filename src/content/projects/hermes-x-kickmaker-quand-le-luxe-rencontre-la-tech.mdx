...
Le cuir d'abord : la même qualité que la maroquinerie de la maison, coutures sellier comprises. L'extérieur ensuite : de l'aluminium brossé, usiné en CNC. Le genre de finition qu'on trouve sur un objet de luxe, pas sur un chargeur.

![L'extérieur en aluminium brossé, usiné en CNC : la finition d'un objet de luxe, pas d'un gadget.](/projects/hermes-alu.webp)
...
*Visuel produit : accessoire de charge Hermès × Apple (© Hermès). Les autres images sont des illustrations libres de droits (Unsplash) et ne représentent pas le produit réel.*
