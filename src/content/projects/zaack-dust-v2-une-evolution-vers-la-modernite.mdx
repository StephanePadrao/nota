...
dates: '2022-2023'
active: false
description: "Le capteur de poussière DUST de Zaack, en service depuis 2019, déraillait sur le terrain : fausse jauge de batterie, déconnexions LoRa, composants en fin de vie. Diagnostic SAV à l'appui, je l'ai fait évoluer en V2, capteur numérique, radio intégrée, antenne externe et alimentation repensée, sans le réinventer."
technologies:
  - Conception produit
  - Capteur IoT
  - LoRa
...
---
Le DUST de Zaack est un petit capteur qui vit dans les conduits de ventilation industrielle. Il mesure leur encrassement, la poussière qui s'y dépose, remonte la donnée en LoRa vers le cloud de Zaack, et déclenche le nettoyage d'un conduit seulement quand il en a besoin, au lieu d'envoyer un technicien à date fixe. Zaack appartient au groupe Igienair, dont le métier est justement le nettoyage de ventilation. La V1 était en service depuis 2019. Chez Kickmaker, j'ai été le référent technique et chef de projet de la V2 : d'abord comprendre pourquoi la V1 déraillait sur le terrain, puis la faire évoluer sans la réinventer.
...
La V1 marchait, mais le terrain remontait deux problèmes tenaces. Le premier : après un simple changement de piles, certains appareils envoyaient un niveau de batterie incohérent, sans rapport avec la tension réelle. Le second : des déconnexions LoRa à répétition, dues à une antenne interne mal maîtrisée. À cela s'ajoutait une raison de fond, moins visible : des composants clés en fin de vie ou difficiles à sourcer, et un banc de production qui accumulait les soucis, rétention des cartes, bug de flash, aucun test électrique réel, rejets aléatoires. Un produit à faire vieillir proprement, plutôt qu'à laisser dériver.

## le bug de la jauge de batterie

Avant de redessiner quoi que ce soit, j'ai mené l'expertise sur le défaut le plus gênant, la fausse jauge de batterie. Premier réflexe, écarter la surconsommation : l'analyseur de courant ne montrait aucune différence entre cartes saines et cartes défectueuses. Le problème était donc dans la chaîne de mesure de la tension, pas dans la consommation.
...
Le capteur de poussière, d'abord. La V1 mesurait la lumière infrarouge renvoyée par la poussière avec une LED, une photodiode et un ampli analogique : une chaîne qui dérive avec la température et qu'il faut corriger après coup. La V2 passe à un capteur optique tout-en-un, numérique, avec compensation thermique intégrée, pilotage de LED optimisé et un vrai mode veille. On gagne en justesse et en consommation d'un coup.
...
L'alimentation, enfin. La V1 embarquait trois piles AAA dont elle n'exploitait qu'une partie de la charge, parce que l'électronique ne fonctionnait plus sous 3,3 V. La V2 passe à deux piles AA et un convertisseur élévateur qui fabrique le 3,3 V même quand les piles sont presque vides. On vide réellement les piles, on réduit le coût et la nomenclature, et on tient toujours les quatre ans et plus d'autonomie visés.
...
Sur ce projet, j'ai porté le diagnostic SAV, le cahier des charges de la V2, et le bring-up des premières cartes. La leçon, je la mets en regard d'autres refontes que j'ai menées : tout reconstruire n'est pas toujours la bonne réponse. Sur un produit déjà installé chez des clients, l'évolution ciblée, guidée par les vrais retours terrain et par le sourcing, vaut mieux qu'une rupture. La plus belle correction du projet n'a pas changé une ligne du PCB : un ampli op de même boîtier, choisi pour la bonne raison, et une jauge qui redevient juste. Moderniser, ici, ce n'était pas tout refaire : c'était corriger ce qui faussait la mesure et donner au produit les moyens de se faire installer, tester et réparer.
