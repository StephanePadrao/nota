...
function publishContent() {
  ...
  const script =
    "git add src/content/projects src/content/albums src/content/blog src/data/profile.json src/data/profile.en.json src/data/profile.es.json src/data/profile.pt.json public && " +
